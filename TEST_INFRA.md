...
/
├── receiver/
│   └── receiver.py        # Target under test (WebSocket server)
├── tests/
...
│   ├── test_stress.py      # Stress and lifecycle testing suite
│   ├── test_non_ascii.py   # Unicode input crash testing
│   ├── verify_zombies.py   # Subprocess cleanups verification
