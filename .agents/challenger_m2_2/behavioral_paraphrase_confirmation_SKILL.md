---
name: behavioral-paraphrase-confirmation
description: >-
  A global requirement to explicitly summarize interpretations of user requests and wait for confirmation before taking action or making changes.
---
...
**User**: Add a recurring billing module to the invoice engine.
**Agent**: To confirm my interpretation: You want me to build a recurring billing module into the invoice engine so it can automatically generate and schedule invoices on a recurring basis. Is this interpretation correct?
**User**: Yes, exactly.
**Agent**: Great, I will start planning the implementation now.
